...
class ProjectsScreen extends StatelessWidget {
              ...
              Obx(() {
                ...
                return ResponsiveGridView.builder(
                  ...
                  gridDelegate: ResponsiveGridDelegate(
                    ...
                    minCrossAxisExtent: ResponsiveValue<double>(context, defaultValue: 300.0,  conditionalValues: []).value ?? 300.0,
                    childAspectRatio: ResponsiveValue<double>(context, defaultValue: 0.7, conditionalValues: []).value ?? 0.8,
  ...
  Widget _buildFilterChips(BuildContext context) { // Added context parameter
    return Obx(() => Wrap(
      spacing: 8.0,
      runSpacing: 8.0,
      children: [
        ChoiceChip(
          ...
          labelStyle: TextStyle(
            color: controller.selectedTag.value.isEmpty
                ? (Theme.of(context).brightness == Brightness.dark ? Colors.black : Colors.white)
                : null,
          ),
        ),
        ...controller.allTags.map((tag) => ChoiceChip(
          ...
          selectedColor: Theme.of(context).colorScheme.secondary.withOpacity(0.7),
          labelStyle: TextStyle(
            color: controller.selectedTag.value == tag
