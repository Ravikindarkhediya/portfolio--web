...
class AppTheme {
  static ThemeData lightTheme = ThemeData(
    ...
    hintColor: AppColors.accentLight, // Used for accent color
    textTheme: const TextTheme(
      displayLarge: TextStyle(color: AppColors.textLight, fontWeight: FontWeight.bold),
      titleLarge: TextStyle(color: AppColors.textLight, fontWeight: FontWeight.w600),
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    appBarTheme: const AppBarTheme(
      ...
      titleTextStyle: TextStyle(color: AppColors.textDark, fontSize: 20, fontWeight: FontWeight.w500),
    ),
